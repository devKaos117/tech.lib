...
BEHAVIOUR
	...
	-L
		Automatically saves the changes in the hive files without prompting the user and log all changed filenames to /tmp/changed
...
INTERACTION
	...
	-e
		Use the registry editor with limited capabilities
	-d
		Use buffer debugger instead
	-i
