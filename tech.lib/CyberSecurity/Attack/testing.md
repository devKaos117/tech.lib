...
### Blind
When database responses are never returned to us, we can analytically infer information based on the application behavior when boolean or time-based logic are injected
